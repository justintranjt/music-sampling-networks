...
\begin{figure}[H]
\makebox[\textwidth]{\includegraphics{topSamplingGenresPercent}}
...
\begin{figure}[H]
\makebox[\textwidth]{\includegraphics{TimePeriods/samplingTimePeriod}}
...
\begin{figure}[H]
\makebox[\textwidth]{\includegraphics{topSampledGenresPercent}}
...
\begin{figure}[H]
\makebox[\textwidth]{\includegraphics{./genreRatio/genreRatioHiphop}}
...
\begin{figure}[H]
\makebox[\textwidth]{\includegraphics[scale=0.52]{./genreRatio/genreRatioElectronicRock}}
\centering
...
\begin{figure}[H]
\makebox[\textwidth]{\includegraphics{./genreRatio/genreRatioReggae}}
...
\begin{figure}[H]
\makebox[\textwidth]{\includegraphics[scale=0.55]{./audioElemSampledBy/audioElemElectronicHip}}
\centering
...
\begin{figure}[H]
\makebox[\textwidth]{\includegraphics{./EgoGraphs/egoGraphMostSampled2TheWinstons}}
...
\subsection{Most Influential Artists}
 % Can you give an intuitive understanding of the difference?
...
\caption{Top Artists by Centrality (1990's)}
\label{table:table3}
\end{table}
\begin{table}[H]
\resizebox{\textwidth}{!}{%
...
\cline{1-5}
\textbf{n'th Largest Louvain Community (\# of Artists)} & \multicolumn{4}{c|}{\textbf{Genre (\% in n'th Largest Community)}} &  \\ \cline{1-5}
\textbf{} & {\ul Hip-Hop/R\&B} & {\ul Electronic/Dance} & {\ul Rock/Pop} & {\ul Soul/Funk/Disco} &  \\ \cline{1-5}
1. (1420 Artists) & 55.56\% & 14.23\% & 10.35\% & 7.46\% &  \\ \cline{1-5}
2. (1384 Artists) & 59.68\% & 20.45\% & 5.56\% & 7.44\% &  \\ \cline{1-5}
3. (1024 Artists) & 56.84\% & 19.04\% & 6.64\% & 8.11\% &  \\ \cline{1-5}
4. (754 Artists) & 55.57\% & 14.06\% & 7.29\% & 9.42\% &  \\ \cline{1-5}
5. (746 Artists) & 12.20\% & 60.59\% & 8.71\% & 2.41\% &  \\ \cline{1-5}
\end{tabular}%
}
...
\begin{figure}[H]
\makebox[\textwidth]{\includegraphics{LouvainCommunities/louvain1st}}
